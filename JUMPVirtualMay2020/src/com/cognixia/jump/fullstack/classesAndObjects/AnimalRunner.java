...
//		System.out.println(cat1.getWeight() + " " + cat1.getName() + " " + cat1.getId());
//		System.out.println(cat2.getWeight() + " " + cat2.getName() + " " + cat2.getId());
//		System.out.println(cat3.getWeight() + " " + cat3.getName() + " " + cat3.getId());
//		System.out.println(cat4.getWeight() + " " + cat4.getName() + " " + cat4.getId());
//		
//		System.out.println(Cat.count);
